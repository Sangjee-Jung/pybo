...
urlpatterns = [
    ...
    path('industry-landscape/0', views.industry_landscape_0, name='industry_landscape_0'),
    path('industry-landscape/1', views.industry_landscape_1, name='industry_landscape_1'),
    ...
    path('industry-landscape/2_2', views.industry_landscape_2_2, name='industry_landscape_2_2'),
    ...
    path('industry-landscape/3_3', views.industry_landscape_3_3, name='industry_landscape_3_3'),
